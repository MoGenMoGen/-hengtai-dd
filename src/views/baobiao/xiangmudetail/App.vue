	...
	<div class="content">
			...
			<div class="bodyContent">
				...
				<div class="searchBox">
					 <div class="boxOne">
						...
						<input placeholder="部门名称" v-model="name"  v-if="currentRole==2"/>
					 </div>
				...
				<div class="header">
					<div class=" headname" v-if="currentRole==1">
						姓名
					</div>
		...
		<div class="bottom">
			<div class="list" v-for="item in 30">
				...
				<div class="listName" v-if="currentRole==2" style="color:#CA093A; text-decoration: underline;"@click="toDetail">
					查看
				</div>
