    ...
    <div class="main">
      ...
      <div class="situation">
        ...
        <div class="content">
          ...
          <p v-if="info.appraiseLevel == 1">
            <span>满意度评价：</span>一般满意
          </p>
          <p v-if="info.appraiseLevel == 2"><span>满意度评价：</span>满意</p>
          <p v-if="info.appraiseLevel == 3">
            <span>满意度评价：</span>非常满意
          </p>
        </div>
      </div>
      <div class="content">
  ...
  methods: {
    ...
    async getInfo() {
      ...
      this.info.assignTime = this.info.assignTime
        ...
        : "";
      this.info.finallyTime = this.info.finallyTime
        ? this.info.finallyTime.split(" ")[0]
        : "";
