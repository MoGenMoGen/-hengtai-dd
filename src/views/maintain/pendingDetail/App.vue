  ...
  <div id="container">
    ...
    <div class="main">
      <div class="info">
        ...
        <p @click="toPage()"><span>车架号：</span>{{ info.vin }}</p>
...
export default {
  ...
  methods: {
    toPage() {
      let url = "/views/maintain/carDetail.html?id=" + this.info.vehicleId;
      this.until.href(url);
    },
    async getStaffList() {
    ...
    receipt() {
      ...
      this.api.serviceApply(param).then((res) => {
        ...
        setTimeout(() => {
          this.until.href("/views/maintain/index.html?cd=3&serviceCd=2");
        }, 1500);
      });
    },
    back() {
