<template>
  <div id="container">
    ...
    <div class="bodyContent">
      ...
      <div class="bodyList">
        <div class="list">
          <div class="listHead">客户姓名:</div>
          <div class="listContent">
            {{ info.name }}
          </div>
        </div>
        <div class="list">
          <div class="listHead">联系电话:</div>
          <div class="listContent">
            {{ info.phone }}
          </div>
        </div>
        ...
        <div class="list">
          <div class="listHead">客户类型:</div>
          <div class="listContent">
            {{ info.customerType }}
          </div>
        </div>
        <div class="list">
          <div class="listHead">来访人数:</div>
          <div class="listContent">
            {{ info.people }}
          </div>
        </div>
        <div class="list">
          <div class="listHead">来访时间:</div>
          <div class="listContent">
            {{ info.visitingPeriod }}
          </div>
        </div>
    ...
    <div class="bodyContent">
      <div class="contentTitle">客户需求</div>
      <div class="bodyList">
        <div class="list">
          {{ info.demand }}
        </div>
        <div class="list">
          <div class="listHead">客流性质:</div>
          <div class="listContent">
            {{ info.nature }}
          </div>
        </div>
        <div class="list">
          <div class="listHead">销售顾问:</div>
          <div class="listContent">
            {{ info.saler }}
          </div>
        </div>
    ...
    <div class="btn">
      <button type="button" @click="perfectTo" v-if="info.gearStatus == false">
        信息完善
      </button>
      <button
        type="button"
        v-if="info.gearStatus == true"
